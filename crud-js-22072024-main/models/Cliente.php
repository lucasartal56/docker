...
class Cliente extends Conexion
{
    ...
    {
        $sql = "INSERT INTO clientes(cliente_nombre, cliente_apellido, cliente_nit) values('$this->cliente_nombre', '$this->cliente_apellido', '$this->cliente_nit', '$this->cliente_telefono')";
