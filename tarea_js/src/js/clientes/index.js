...
const getClientes = async (alerta='si') => {
    ...
    const url = `/martinez_artal_IS2_crud_js/controllers/clientes/index.php?cli_nombre=${nombre}&cli_apellido=${apellido}&cli_nit=${nit}&cli_telefono=${telefono}`
    const config = {
        method: 'GET'
    }
...
const guardarCliente = async (e) => {
    ...
    const url = '/martinez_artal_IS2_crud_js/controllers/clientes/index.php'
