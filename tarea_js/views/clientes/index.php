...
<div class="container mt-5">
    ...
    <div class="row justify-content-center mb-3">
        <form class="col-lg-8 border bg-light p-3">
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="cli_nombre">Nombres</label>
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="cli_nit">Número de Nit</label>
...
<script defer src="/martinez_artal_IS2_crud_js/src/js/funciones.js"></script>
<script defer src="/martinez_artal_IS2_crud_js/src/js/clientes/index.js"></script>
